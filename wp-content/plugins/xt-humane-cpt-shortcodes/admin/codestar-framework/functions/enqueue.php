...
if( ! function_exists( 'cs_admin_enqueue_scripts' ) ) {
  function cs_admin_enqueue_scripts() {
    ...
    wp_enqueue_style( 'humane', CS_URI .'/assets/css/cs-framework.css', array(), '1.0.0', 'all' );
    ...
    wp_enqueue_script( 'humane',  CS_URI .'/assets/js/cs-framework.js',  array( 'cs-plugins' ), '1.0.0', true );
