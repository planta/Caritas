...
/* Add custom class for fullwidth row */

if( isset( $atts['use_container'] ) && $atts['use_container'] == 'yes' ) {
	$css_classes[] = 'xt_kc_row_has_container';
}else{
	$css_classes[] = 'xt_kc_row_full_width';
}

/* Add custom class for row padding */

if( isset( $atts['xt_row_padding'] ) && $atts['xt_row_padding'] == 'yes' ) {
	$css_classes[] = 'xt_kc_row_has_padding';
}else{
	$css_classes[] = 'xt_kc_row_no_padding';
}

/* Custom Class for row color */

if( isset( $atts['xt_row_color'] ) && $atts['xt_row_color'] == 'white' ) {
	$css_classes[] = 'xt_kc_row_white_color';
}
