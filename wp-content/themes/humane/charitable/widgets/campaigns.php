...
echo wp_kses_post( $view_args['before_widget'] );

if ( ! empty( $view_args['title'] ) ) :

	echo wp_kses_post( $view_args['before_title'] . $view_args['title'] . $view_args['after_title'] );
...
while ( $campaigns->have_posts() ) :
	...
	?>
	<li class="campaign<?php echo esc_attr( $show_thumbnail && has_post_thumbnail() ? ' row' : '' ); ?>">
...
echo wp_kses_post( $view_args['after_widget'] );
