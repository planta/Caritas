...
<div class="campaign-donation">
	<a data-trigger-modal="charitable-donation-form-modal-loop"
		...
		aria-label="<?php echo esc_attr( sprintf( esc_html_x( 'Make a donation to %s', 'make a donation to campaign', 'humane' ), esc_html( get_the_title( $campaign->ID ) ) ) ) ?>">
		<?php esc_html_e( 'Donate', 'humane' ) ?>
	</a>
</div>
