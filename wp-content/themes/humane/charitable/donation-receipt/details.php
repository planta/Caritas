...
?>
<h3 class="charitable-header"><?php esc_html_e( 'Your Donation', 'humane' ) ?></h3>
<table class="donation-details charitable-table table table-bordered">
    <thead>
        <tr>
            <th><?php esc_html_e( 'Campaign', 'humane' ) ?></th>
            <th><?php esc_html_e( 'Total', 'humane' ) ?></th>
        </tr>
    </thead>
    <tbody>
    ...
    <tfoot>
        ...
        ?>
        <tr>            
            <td><?php esc_html_e( 'Total', 'humane' ) ?></td>
            <td><?php
                /**
