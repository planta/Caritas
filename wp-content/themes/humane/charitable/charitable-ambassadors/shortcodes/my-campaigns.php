...
<ul class="charitable-user-campaigns charitable-user-posts">
    ...
    if ( $campaigns->have_posts() ): ?>
        ...
        <?php while ( $campaigns->have_posts() ) : 
            ...
            ?>
            <li class="charitable-campaign charitable-user-post charitable-campaign-<?php echo esc_attr( $campaign->get_status() ) ?>">

                <span class="humane-campaign-status"><?php echo esc_html( $campaign->get_status() ); ?></span>
...
<p class="start-campaign">
    <a href="<?php echo esc_url( charitable_get_permalink( 'campaign_submission_page' ) ) ?>" class="button button-primary"><?php echo apply_filters( 'charitable_ambassadors_my_campaigns_button_text', esc_html__( 'Create a new campaign', 'humane' ) ); ?></a>
</p>
