	...
	if ( $form->has_key() ) :
		...
		<form id="resetpassform" class="charitable-form" method="post" autocomplete="off">
			...
			<div class="charitable-form-field charitable-submit-field resetpass-submit">
				<button id="resetpass-button" class="button button-primary btn btn-fill btn-lg lostpassword-button" type="submit"><?php esc_html_e( 'Reset Password', 'humane' ) ?></button>
			</div>
		</form>
		<?php
