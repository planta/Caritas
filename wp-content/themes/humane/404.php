...
get_header(); ?>
	<div id="primary" class="content-area <?php echo esc_attr( apply_filters( 'humane_content_area_class', 'col-md-8' ) ); ?>">
		<main id="main" class="site-main">
			...
			<section class="error-404 not-found shadow humane-shadow-padding clearfix">
				<header class="ch-page-header">
					<h2 class="page-title"><?php esc_html_e( '404 Not Found', 'humane' ) ?></h2>
				</header><!-- .page-header -->
				...
				<div class="page-content">
					...
					it with the information below.', 'humane' ); ?></p>
					<div class="ch-back-top-home-btn">
						<a class="btn btn-fill btn-lg" href="<?php echo esc_url( home_url() ); ?>"><?php esc_html_e( 'Back to home', 'humane' ) ?></a>
					</div>
				</div><!-- .page-content -->
				...
				<div class="ch-404-additional-info row">
					...
					<?php
						...
						if ( humane_categorized_blog() ) :
					?>

						<div class="col-md-6 ch-404-additional-info-item">
							<div class="widget widget_categories">
								<h2 class="widget-title"><?php esc_html_e( 'Most Used Categories', 'humane' ); ?></h2>
								<ul>
								<?php
